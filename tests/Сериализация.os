...
&Тест
Процедура СериализацияПолейБезМодификатораЭкспорт() Экспорт

	// Дано
	ТестовыйКласс = Новый ТестовыйКлассСмешанныеПоля();
	ТестовыйКласс.ПолеСЭкспортом = "ЗначениеЭкспорт";
	ТестовыйКласс.ПолеБезЭкспорта = "ЗначениеБезЭкспорт";
	ТестовыйКласс.ПереименованноеПолеСЭкспортом = "ПереименованноеЭкспорт";
	ТестовыйКласс.ПереименованноеПолеБезЭкспорта = "ПереименованноеБезЭкспорт";
	...
	// Проверяем, что поля БЕЗ модификатора Экспорт тоже сериализуются
