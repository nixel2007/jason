...
Процедура СериализацияКласса() Экспорт
	...
	Ожидаем.Что(ПрочитанныйОбъект.Таблица).ИмеетДлину(3);
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[0][0]).Равно("колонка1");
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[0][1]).Равно("колонка2");
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[1][0]).Равно(1);
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[1][1]).Равно(2);
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[2][0]).Равно(3);
	Ожидаем.Что(ПрочитанныйОбъект.Таблица[2][1]).Равно(4);
...
Процедура СериализацияКорневойТаблицыЗначений() Экспорт
	...
	Ожидаем.Что(Объект).ИмеетДлину(3);
	Ожидаем.Что(Объект[0][0]).Равно("x");
	Ожидаем.Что(Объект[0][1]).Равно("y");
	Ожидаем.Что(Объект[1][0]).Равно(1);
	Ожидаем.Что(Объект[1][1]).Равно(2);
	Ожидаем.Что(Объект[2][0]).Равно("a");
	Ожидаем.Что(Объект[2][1]).ИмеетТип("Структура");
	Ожидаем.Что(Объект[2][1]["x"]).Равно(3);
